...
@endif
    ...
    @if ($document->detraction)
        ...
        <tr>
            ...
            <td><p class="m27-value">S/ {{ $document->detraction->amount}}</p></td>
        </tr>
    ...
    @if ($document->retention)
        ...
        <tr>
            ...
            <td><p class="m27-value">S/ {{ $document->getRetentionTaxBase() }} </p></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><p class="m27-value">S/ {{ $document->retention->amount_pen }}</p></td>
        </tr>
    @endif
