        ...
        <td width="47%" class="border-box pl-3 align-top">
            <table class="full-width">
                ...
                <tr>
                    ...
                    <td class="font-sm" width="8px">:</td>
                    <td class="font-sm">
                        {{ format_identity_document($supplier->identity_document_type_id ?? null, $supplier->number) }}
                    </td>
                </tr>
                @php
                    $addressParts = [];
...
<table class="full-width mt-10 mb-10">
    ...
    @endfor
        ...
        <tr>
            ...
            <td colspan="6" class="p-1 text-right align-top desc cell-solid font-bold">IVA: {{ $document->currency_type->symbol }}</td>
