...
<aside id="sidebar-left" class="sidebar-left mt-0" style="z-index: 900">
    ...
    <div class="nano px-2">
        <div class="nano-content">
            ...
            @if($sysAdmin && $sysAdmin->canAccessSystemModule('business-turns'))
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="{{ ($path[0] === 'business-turns')?'nav-active':'' }}">
                        <a class="nav-link" href="{{route('system.business-turns.index')}}">
            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="{{ ($path[0] === 'storage-management')?'nav-active':'' }}">
                        <a class="nav-link" href="{{route('system.storage-management.index')}}">
            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="{{ ($path[0] === 'services')?'nav-active':'' }}">
                        <a class="nav-link" href="{{ route('system.services') }}">
