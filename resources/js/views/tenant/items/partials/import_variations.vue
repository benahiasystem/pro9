    ...
    <el-dialog :title="titleDialog" :visible="showDialog" @close="close" @open="create" class="dialog-import">
        <form autocomplete="off" @submit.prevent="submit">
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="/formats/item_variations.xlsx" target="_new">Descargar formato</a>
                    </div>
                    <div class="col-md-12 mt-3">
                        <small class="text-muted d-block">
                            Vincula productos existentes por <strong>Código Interno</strong> y genera combinaciones.
                            Ejemplo de Variaciones:
                            <code>Talla: S, M, L; Color: Rojo#FF0000, Azul#0000FF</code>
                        </small>
                    </div>
                    <div class="col-md-12 mt-4">
                        <div class="form-group text-center" :class="{'has-danger': errors.file}">
                            <el-upload
                                ref="upload"
                                :headers="headers"
                                action="/items/import/variations"
                                :show-file-list="true"
                                :auto-upload="false"
                                :multiple="false"
...
export default {
    ...
    methods: {
        ...
        create() {
            this.titleDialog = 'Importar Variaciones'
        },
        async submit() {
