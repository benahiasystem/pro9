    ...
    <el-dialog :close-on-click-modal="false"
        ...
        <span slot="title" class="ifb-dialog-title">
            ...
            <span class="ifb-dialog-title-actions">
                ...
                <template v-else>
                    <button class="btn btn-sm second-buton edit-layout-btn" @click="enterLayoutEditFromHeader">
        ...
        <form autocomplete="off"
            ...
            <item-form-pinned-bar ref="pinnedBar"
                ...
                <!-- El campo fijado no ofrece un control interactivo. -->
            ...
            <el-tabs v-model="activeName" @tab-click="handleTabClick">
                <el-tab-pane v-if="showTab('general')"
                    ...
                    <div class="row">
                        ...
                        <!-- ########## INICIO CAMBIO: OCULTAR IMPUESTO A LA BOLSA PLÁSTICA -->
                        <!-- El campo se conserva en el estado, pero no se renderiza ni puede fijarse. -->
                        <!-- ######### FIN CAMBIO: OCULTAR IMPUESTO A LA BOLSA PLÁSTICA -->
                        ...
                        <!-- Campo fiscal item_code retirado de este formulario; se conserva el contrato de datos. -->
...
<!--                                        <td>{{ row.item_id }}</td>-->
                ...
                <el-tab-pane v-if="showTab('advanced')"
                    ...
                    <div class="advanced-section">
                        ...
                        <div class="row">
                            <!-- ########## INICIO CAMBIO NELSON: RETIRO CÓDIGO SUNAT -->
                            <!-- item_code permanece en el contrato de datos, sin exposición en el formulario. -->
                            <!-- ######### FIN CAMBIO NELSON: RETIRO CÓDIGO SUNAT -->
                            <div class="col-md-4">
