<template>
    <form v-if="canDeleteTestDocuments" autocomplete="off" @submit.prevent="confirmDeleteDocuments">
    ...
    export default {
        ...
        methods: {
            ...
            confirmDeleteDocuments() {
                ...
                this.$prompt(
                    'Esta acción elimina permanentemente los documentos de prueba y sus registros relacionados. Escribe ELIMINAR para confirmar.',
                    'Confirmar eliminación',
                    {
                        confirmButtonText: 'Eliminar',
                        cancelButtonText: 'Cancelar',
                        inputPattern: /^ELIMINAR$/,
                        inputErrorMessage: 'Debes escribir ELIMINAR para continuar.',
                        closeOnClickModal: false,
                    }
                ).then(() => this.deleteDocuments()).catch(() => {})
                // ######## FIN PC-17 CONFIRMACIÓN DE ELIMINACIÓN ########
            },
            deleteDocuments() {
                this.loading_submit = true
                this.$http.post(`/${this.resource}/delete_documents`, { confirmation: 'ELIMINAR' })
                    .then(response => {
