...
3. Centralizar la normalización PHP en `Localization::normalizePhone`; usar lógica equivalente en JavaScript cuando no se pueda invocar el helper.
...
6. Usar el teléfono configurado en enlaces `tel:` y `wa.me`, nunca abonados de ejemplo.
...
9. Delimitar cada modificación de código con comentarios válidos que contengan `########### INICIO` y `########### FIN`.
