...
4. Repetir en cada tenant disponible. Un listado vacío de datos reales no prueba el flujo; usa el producto temporal que satisface los filtros.
5. Verificar en `information_schema` tipo nullable, índice y FK.
6. En una base temporal, ejecutar todas las migraciones, volver a ejecutar la reparación y probar rollback/up de esa reparación.
