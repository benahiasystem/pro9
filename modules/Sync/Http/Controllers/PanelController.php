...
class PanelController extends Controller
{
        ...
        return response()->json([
            ...
            'data' => collect($page->items())->map(function ($e) {
                ...
                return [
                    ...
                    // La operación local conserva en payload todos los datos reintentables.
                    'can_retry' => $e->status === 'error'
    ...
    /**
     * KPIs de la bandeja: los pendientes dependen de tareas programadas o del
     * reintento manual; este número es el trabajo por continuar.
     */
