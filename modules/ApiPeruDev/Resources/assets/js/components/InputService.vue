...
<script type="text/javascript">
    export default {
        ...
        props: {
            ...
            // para personas (1 = Cédula, 6 = RIF, 4 = CE).
            ...
            // Consulta ademas la licencia de conducir junto con el Cédula. El MTC
        ...
        data() {
            return {
                ...
                service_config: {
                    ...
                    ruc:      {maxLength: 11, buttonText: 'Buscar'},
        ...
        computed: {
            ...
            // La licencia solo se puede resolver desde un Cédula.
            shouldSearchLicense() {
            ...
            searchLicenseByNumber(number) {
                return this.$http.get(`/${this.resource_base}/licencia/${encodeURIComponent(number)}`)
                    .then(response => {
                        ...
                        // para no ensuciar la busqueda de Cédula cuando el
