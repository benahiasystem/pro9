<template>
    <el-drawer
        ...
        size="560px"
        direction="rtl"
        custom-class="detail-drawer order-detail-drawer"
        append-to-body
        @closed="handleClosed"
    >
        <div class="detail-drawer__inner order-detail-drawer__inner" v-loading="loading">
            <div class="theme-sidebar-header detail-drawer__header order-detail-drawer__header">
                <div class="detail-drawer__title order-detail-drawer__title">
            ...
            <template v-if="record">
                <div class="detail-drawer__status-bar order-detail-drawer__status-bar">
                ...
                <div class="detail-drawer__body order-detail-drawer__body">
                    <el-tabs v-model="activeTab">
                        <el-tab-pane label="Productos" name="products">
                            <div class="detail-drawer__section-card order-detail-drawer__section-card">
                                <div class="detail-drawer__section-card-header order-detail-drawer__section-card-header">
                                ...
                                <div v-if="lineItems.length" class="table-responsive">
                                    <table class="table table-sm detail-drawer__items-table order-detail-drawer__items-table mb-0">
                                        <thead>
                                            <tr>
                                                <th>Producto</th>
                            ...
                            <div class="detail-drawer__customer-section">
                                ...
                                <div class="detail-drawer__customer-summary">
                                    ...
                                    <div class="detail-drawer__customer-identity">
                                        ...
                                        <span v-if="customerDocumentTypeLabel" class="detail-drawer__customer-badge" :class="{ 'detail-drawer__customer-badge--warning': customerDocumentTypeIsWarning }">
                                ...
                                <div class="detail-drawer__customer-grid">
                                    ...
                                    <div class="detail-drawer__customer-field">
                                        ...
                                        <div class="detail-drawer__customer-field-content"><span class="detail-drawer__customer-field-label">Dirección de envío</span><strong>{{ shippingAddress || '—' }}</strong></div>
                                    </div>
                                </div>
                            </div>
                        </el-tab-pane>
                            ...
                            <div class="detail-drawer__operation-section">
                                ...
                                <div class="detail-drawer__operation-flow">
                                    ...
                                    <div class="detail-drawer__operation-card">
                                        ...
                                        <div class="detail-drawer__operation-card-content"><span class="detail-drawer__operation-label">Almacén / origen</span><strong>{{ warehouseLabel }}</strong></div>
                                    </div>
                                </div>

                                <div class="detail-drawer__operation-note"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-info-circle" aria-hidden="true"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 9h.01"/><path d="M11 12h1v4h1"/><path d="M12 3a9 9 0 1 0 0 18a9 9 0 0 0 0 -18"/></svg><span>{{ inventoryReferenceNote }}</span></div>
                            ...
                            <div class="detail-drawer__totals-section">
                                ...
                                <div class="detail-drawer__totals-summary">
                                    <div class="detail-drawer__totals-summary-card">
                                        ...
                                        <div class="detail-drawer__totals-summary-content"><span class="detail-drawer__totals-label">Condición de pago</span><strong>{{ paymentConditionLabel }}</strong></div>
                                    </div>
                                    <div class="detail-drawer__totals-summary-card">
                                ...
                                <div class="detail-drawer__totals-card">
                                    <div class="detail-drawer__totals-row">
                                        ...
                                        <span class="detail-drawer__totals-row-label">Op. gravada</span><strong>{{ formatMoney(record.total_taxed) }}</strong>
                                    </div>
                                    <div class="detail-drawer__totals-row">
                                        ...
                                        <span class="detail-drawer__totals-row-label">IGV ({{ igvPercentage }}%)</span><strong>{{ formatMoney(record.total_igv) }}</strong>
                                    </div>
                ...
                <div class="detail-drawer__footer detail-drawer__footer--actions order-detail-drawer__footer">
                    <button
                        v-if="canAnulate"
                        type="button"
...
export default {
    ...
    computed: {
        ...
        shippingAddress() {
            return this.record?.shipping_address
                || this.record?.customer?.address
                || this.record?.customer?.direccion
                || null;
        },
        sellerLabel() {
        ...
        inventoryReferenceNote() {
            if (String(this.record?.state_type_id || '') === '11') {
                return 'Este pedido está anulado. La anulación cambia su estado y libera los lotes asociados; no registra una devolución general de stock.';
            }

            if (this.record?.sale_note_id || this.record?.order_note_id || this.record?.dispatch_id) {
                return 'Este pedido proviene de otro documento. El movimiento de stock depende del documento de origen para evitar descuentos duplicados.';
            }
            ...
            if (String(this.record?.document_type_id || '') === '07') {
                return `Al registrar este pedido, el sistema sumó las cantidades a ${inventoryOrigin} y generó los movimientos de kardex correspondientes.`;
            }

            return `Al registrar este pedido, el sistema descontó las cantidades de ${inventoryOrigin} y generó los movimientos de kardex correspondientes.`;
        },
        currencyLabel() {
