...
<div style="margin-top:20px; margin-bottom:20px;">
            <table class="report-box">
                <tr>
                    <td class="td-custom">
                        <p><strong>Total pagos comprobantes: </strong>{{ $currency_symbol }} {{ $cash_data['total_document_payments'] }}</p>
                    </td>
                    <td class="td-custom">
                        <p><strong>Total pagos notas de venta: </strong>{{ $currency_symbol }} {{ $cash_data['total_sale_note_payments'] }}</p>
                    </td>
                </tr>
            </table>
        </div>
