...
<div style="margin-top:20px; margin-bottom:20px;">
    <table>
        ...
        <tr>
            <td class="td-custom">
                <p><strong>Saldo inicial efectivo:</strong>&nbsp; {{ $currencySymbol }} {{$data['cash_beginning_balance']}}</p>
            </td>
            <td class="td-custom">
                <p><strong>Ingreso efectivo:</strong>&nbsp; {{ $currencySymbol }} {{ $data['cash_income_pen'] }}</p>
            </td>
        </tr>
        <tr>
            <td class="td-custom">
                <p><strong>Saldo final efectivo:</strong>&nbsp; {{ $currencySymbol }} {{ $data['balance_cash_pen'] }} </p>
            </td>
            <td class="td-custom">
                <p><strong>Egreso efectivo:</strong>&nbsp; {{ $currencySymbol }} {{$data['cash_egress_pen']}} </p>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
