...
<div style="margin-top:5px; margin-bottom:10px;">
    ...
    <p><strong>Saldo inicial: </strong>{{ $currencySymbol }} {{$data['cash_beginning_balance']}}</p>
    <p><strong>Ingreso: </strong>{{ $currencySymbol }} {{ $data['cash_income'] }} </p>
    <p><strong>Saldo final: </strong>{{ $currencySymbol }} {{$data['cash_final_balance']}} </p>
    <p><strong>Egreso: </strong>{{ $currencySymbol }} {{$data['cash_egress']}} </p>

    <p><strong>Total caja: </strong>{{ $currencySymbol }} {{$data['total_cash_payment_method_type_01']}} </p>

    <p>&nbsp;</p>
    <p><strong>Por cobrar: </strong>{{ $currencySymbol }} {{$data['credit']}} </p>
    <p><strong>Notas de Débito:</strong>{{ $currencySymbol }} {{$data['nota_debito']}}</p>
    <p><strong>Notas de Crédito: </strong> {{ $currencySymbol }} {{ $data['nota_credito'] }}</p>

    <p><strong>Total propinas: </strong>{{ $currencySymbol }} {{$data['total_tips'] ?? 0}} </p>
    <p><strong>Total efectivo CPE: </strong>{{ $currencySymbol }} {{$data['total_payment_cash_01_document'] ?? 0}} </p>
    <p><strong>Total efectivo NOTA DE VENTA: </strong>{{ $currencySymbol }} {{$data['total_payment_cash_01_sale_note'] ?? 0}} </p>
</div>
