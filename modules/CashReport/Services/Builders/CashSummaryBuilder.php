...
/**
 * Reporte de caja (detallado, resumen ticket, simple y excel).
 * Lógica trasladada desde Modules\Pos\Http\Controllers\CashController.
 */
class CashSummaryBuilder implements CashReportBuilderInterface
{
    private const PAYMENT_METHOD_TYPE_CASH = '01';

    public function build(Cash $cash, array $options): array
    {
        $data = $this->setDataToReport($cash->id, $options['summary'] ?? 0);
        ...
        foreach ($cash_documents as $cash_document) {
            ...
            if ($cash_document->sale_note) {
                ...
                $temp = [
                    ...
                    'customer_number'           => format_person_identity_document($sale_note->customer),
            ...
            elseif ($cash_document->technical_service) 
            {
                ...
                if($technical_service->applyToCash())
                {
                    ...
                    $temp = [
                        ...
                        'customer_number'           => format_person_identity_document($technical_service->customer),
            ...
            elseif ($cash_document->expense_payment)
            {
                ...
                $temp = [
                    ...
                    'customer_number'           => format_person_identity_document($expense_payment->expense->supplier),
            ...
            /** Documentos de Tipo compras */
                ...
                $temp = [
                    ...
                    'customer_number'           => format_person_identity_document($purchase->supplier),
            ...
            else if ($cash_document->quotation)
            {
                ...
                if($quotation->applyQuotationToCash())
                {
                    ...
                    $temp = [
                        ...
                        'customer_number'           => format_person_identity_document($quotation->customer),
