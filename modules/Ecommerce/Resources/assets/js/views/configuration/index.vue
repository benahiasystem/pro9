              ...
              <tr v-for="row in campaignRows" :key="row.id || 'placeholder'">
                ...
                <td class="text-start">
                  <el-tag v-if="row.sp_discount_price" type="danger" size="small">
                    {{ row.discount_type === 'percentage' ? row.discount_value + '%' : 'Bs.. ' + row.discount_value }}
                  </el-tag>
            ...
            <template v-if="campaignForm.sp_discount_price || campaignForm.sp_countdown">
              <div class="col-12 mt-3 mb-1">
                ...
                <small class="text-muted d-block mb-2">
                  ...
                  (ej.: producto a Bs. 100 con 50% → muestra Bs. 150 tachado y Bs. 100 de oferta).
                </small>
              </div>
              <div class="col-md-4 form-group">
                ...
                <el-select v-model="campaignForm.discount_type" class="w-100">
                  ...
                  <el-option label="Monto Fijo (Bs..)" value="fixed"></el-option>
                </el-select>
              </div>
              <div class="col-md-4 form-group">
