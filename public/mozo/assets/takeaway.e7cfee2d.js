import { b as defineComponent, N as Notyf, t as reactive, a as computed, r as ref, L as watch, o as onMounted, f as openBlock, g as createElementBlock, w as createVNode, Z as unref, X as createBaseVNode, Y as normalizeClass, D as createTextVNode, z as toDisplayString, B as withCtx, C as createCommentVNode, v as createBlock, a6 as withDirectives, ar as vShow, S as isRef, F as Fragment, G as pushScopeId, H as popScopeId, _ as createStaticVNode, e as useHead } from "./vendor.3c361039.js";
import { p as pageTitle } from "./sidebarLayoutState.95d1bd22.js";
import { _ as _sfc_main$2, M as MoveAmbienteModal, a as _sfc_main$4, b as _sfc_main$7, c as _sfc_main$8 } from "./MoveAmbienteModal.1040ce73.js";
import { _ as _sfc_main$3, a as _sfc_main$5 } from "./ProductModifiersDialog.4a3ec35d.js";
import { _ as _sfc_main$6, a as __unplugin_components_4 } from "./VButton.03b0164c.js";
import { _ as __unplugin_components_5 } from "./VPlaceloadWrap.d6fb1891.js";
import { u as useMesaSession, D as DEFAULT_ENVIRONMENT, d as MESA_NO_DISPONIBLE, e as MESA_DISPONIBLE, b as MesaService } from "./masterService.f5028f32.js";
...
import { P as PedidoEnvironment, B as BagDetails } from "./PedidoEnvironment.43307d1c.js";
...
const _withScopeId = (n) => (pushScopeId("data-v-3719869c"), n = n(), popScopeId(), n);
const _hoisted_1$1 = {
  key: 0,
...
const _hoisted_17 = /* @__PURE__ */ createStaticVNode('<div class="legend-item" data-v-3719869c><span class="legend-indicator notavailableandorderpending" data-v-3719869c></span><span class="legend-text" data-v-3719869c>Ordenes pendientes</span></div><div class="legend-item" data-v-3719869c><span class="legend-indicator notavailableandorderserved" data-v-3719869c></span><span class="legend-text" data-v-3719869c>Ordenes servidas</span></div>', 2);
...
const _hoisted_32 = /* @__PURE__ */ createStaticVNode('<div class="legend-item" data-v-3719869c><span class="legend-icon-edit disponible" data-v-3719869c><i class="fa-solid fa-check" data-v-3719869c></i></span><span class="legend-text" data-v-3719869c>Disponible</span></div><div class="legend-item" data-v-3719869c><span class="legend-icon-edit ocupada" data-v-3719869c><i class="fa-solid fa-check" data-v-3719869c></i></span><span class="legend-text" data-v-3719869c>Ocupada (no se puede desactivar)</span></div><div class="legend-item" data-v-3719869c><span class="legend-icon-edit fuera-servicio" data-v-3719869c><i class="fa-solid fa-ban" data-v-3719869c></i></span><span class="legend-text" data-v-3719869c>Fuera de servicio</span></div><div class="legend-item" data-v-3719869c><span class="legend-indicator moved" data-v-3719869c></span><span class="legend-text" data-v-3719869c>Mesa reubicada</span></div>', 4);
const _hoisted_36 = [
  _hoisted_32
];
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    const selectedDetailsId = ref(null);
    function showDetails(mesa) {
      var _a2;
      selectedDetailsId.value = (_a2 = mesa == null ? void 0 : mesa.id) != null ? _a2 : null;
    }
    const mesaSelectedDetails = computed(() => {
      var _a2;
      if (selectedDetailsId.value == null)
        return null;
      return (_a2 = mesasSession.mesas.find((m) => m.id === selectedDetailsId.value)) != null ? _a2 : null;
    });
    return (_ctx, _cache) => {
        ...
        !unref(viewPos) ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
          createBaseVNode("div", _hoisted_2, [
            ...
            createBaseVNode("div", _hoisted_37, [
              unref(mesaSelectedDetails) && unref(mesaSelectedDetails).id !== 0 && unref(mesaSelectedDetails).environment == "Para Llevar" ? (openBlock(), createElementBlock("div", _hoisted_38, [
                createVNode(BagDetails, { "mesa-select-details": unref(mesaSelectedDetails) }, null, 8, ["mesa-select-details"])
              ])) : createCommentVNode("", true),
              !unref(mesaSelectedDetails) || unref(mesaSelectedDetails).id == 0 || unref(mesaSelectedDetails).environment != "Para Llevar" ? (openBlock(), createElementBlock("div", _hoisted_39, _hoisted_41)) : createCommentVNode("", true)
            ])
          ])
        ])) : createCommentVNode("", true),
...
var TakeawayRestaurant = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-3719869c"]]);
