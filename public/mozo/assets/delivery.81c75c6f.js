...
const _withScopeId = (n) => (pushScopeId("data-v-c07bd2e2"), n = n(), popScopeId(), n);
const _hoisted_1$1 = {
  key: 0,
...
const _hoisted_17 = /* @__PURE__ */ createStaticVNode('<div class="legend-item" data-v-c07bd2e2><span class="legend-indicator notavailableandorderpending" data-v-c07bd2e2></span><span class="legend-text" data-v-c07bd2e2>Ordenes pendientes</span></div><div class="legend-item" data-v-c07bd2e2><span class="legend-indicator notavailableandorderserved" data-v-c07bd2e2></span><span class="legend-text" data-v-c07bd2e2>Ordenes servidas</span></div>', 2);
...
const _hoisted_36 = /* @__PURE__ */ createStaticVNode('<div class="legend-item" data-v-c07bd2e2><span class="legend-icon-edit disponible" data-v-c07bd2e2><i class="fa-solid fa-check" data-v-c07bd2e2></i></span><span class="legend-text" data-v-c07bd2e2>Disponible</span></div><div class="legend-item" data-v-c07bd2e2><span class="legend-icon-edit ocupada" data-v-c07bd2e2><i class="fa-solid fa-check" data-v-c07bd2e2></i></span><span class="legend-text" data-v-c07bd2e2>Ocupada (no se puede desactivar)</span></div><div class="legend-item" data-v-c07bd2e2><span class="legend-icon-edit fuera-servicio" data-v-c07bd2e2><i class="fa-solid fa-ban" data-v-c07bd2e2></i></span><span class="legend-text" data-v-c07bd2e2>Fuera de servicio</span></div><div class="legend-item" data-v-c07bd2e2><span class="legend-indicator moved" data-v-c07bd2e2></span><span class="legend-text" data-v-c07bd2e2>Mesa reubicada</span></div>', 4);
const _hoisted_40 = [
  _hoisted_36
];
        ...
        !unref(viewPos) ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
          createBaseVNode("div", _hoisted_2, [
            ...
            createBaseVNode("div", _hoisted_41, [
              unref(mesaSelectedDetails) && unref(mesaSelectedDetails).id !== 0 && unref(mesaSelectedDetails).environment == "Delivery" ? (openBlock(), createElementBlock("div", _hoisted_42, [
                createVNode(BagDetails, { "mesa-select-details": unref(mesaSelectedDetails) }, null, 8, ["mesa-select-details"])
              ])) : createCommentVNode("", true),
              !unref(mesaSelectedDetails) || unref(mesaSelectedDetails).id == 0 || unref(mesaSelectedDetails).environment != "Delivery" ? (openBlock(), createElementBlock("div", _hoisted_43, _hoisted_45)) : createCommentVNode("", true)
            ])
          ])
        ])) : createCommentVNode("", true),
...
var DeliveryRestaurant = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c07bd2e2"]]);
