...
import { _ as _sfc_main$4 } from "./KanbanDropdown.cc692e1f.js";
import { _ as _sfc_main$3 } from "./VLoader.0f2164f0.js";
import { b as defineComponent, r as ref, f as openBlock, g as createElementBlock, X as createBaseVNode, z as toDisplayString, w as createVNode, B as withCtx, a6 as withDirectives, ar as vShow, F as Fragment, t as reactive, a as computed, o as onMounted, a7 as vModelText, Y as normalizeClass, Z as unref, C as createCommentVNode, A as renderList, D as createTextVNode, e as useHead } from "./vendor.0611facb.js";
import { u as useUserSession, p as provideApi, c as useNotyf } from "./index.5f23ec3b.js";
...
const _hoisted_8 = /* @__PURE__ */ createBaseVNode("div", { class: "collapsed-text" }, "En preparaci\xF3n", -1);
...
const _hoisted_12 = /* @__PURE__ */ createBaseVNode("span", { class: "column-name" }, [
...
const _hoisted_15 = { class: "empty-text" };
const _hoisted_16 = ["data-id"];
const _hoisted_17 = { class: "collapsed-content" };
...
const _hoisted_20 = { class: "task-count" };
const _hoisted_21 = /* @__PURE__ */ createBaseVNode("div", { class: "collapsed-text" }, "Enviados", -1);
const _hoisted_22 = { class: "expanded-content" };
const _hoisted_23 = { class: "column-title" };
const _hoisted_24 = /* @__PURE__ */ createBaseVNode("input", {
  type: "text",
  class: "input is-small rename-input is-hidden"
}, null, -1);
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("span", { class: "column-name" }, [
  /* @__PURE__ */ createBaseVNode("i", { class: "fas fa-circle has-text-primary" }),
  /* @__PURE__ */ createTextVNode(" Enviados ")
], -1);
const _hoisted_26 = { class: "task-count" };
const _hoisted_27 = {
  key: 0,
  class: "kanban-empty"
};
const _hoisted_28 = { class: "empty-text" };
const _hoisted_29 = ["data-id"];
const _hoisted_30 = { class: "collapsed-content" };
...
const _hoisted_33 = { class: "task-count" };
const _hoisted_34 = /* @__PURE__ */ createBaseVNode("div", { class: "collapsed-text" }, "Entregados", -1);
const _hoisted_35 = { class: "expanded-content" };
const _hoisted_36 = { class: "column-title" };
const _hoisted_37 = /* @__PURE__ */ createBaseVNode("input", {
  type: "text",
  class: "input is-small rename-input is-hidden"
}, null, -1);
const _hoisted_38 = /* @__PURE__ */ createBaseVNode("span", { class: "column-name" }, [
  /* @__PURE__ */ createBaseVNode("i", { class: "fas fa-circle has-text-success" }),
  /* @__PURE__ */ createTextVNode(" Entregados ")
], -1);
const _hoisted_39 = { class: "task-count" };
const _hoisted_40 = {
  key: 0,
  class: "kanban-empty"
};
const _hoisted_41 = { class: "empty-text" };
const _hoisted_42 = ["data-id"];
                ...
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_4, [
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("span", _hoisted_7, toDisplayString(unref(recordsInPreparation).length), 1)
                    ]),
                    _hoisted_8
                  ]),
                  createBaseVNode("div", _hoisted_9, [
                    createBaseVNode("div", _hoisted_10, [
                      ...
                      createBaseVNode("h3", null, [
                        _hoisted_12,
                        createBaseVNode("span", _hoisted_13, toDisplayString(unref(recordsInPreparation).length), 1)
                      ]),
                    ...
                    createBaseVNode("div", {
                      ...
                      unref(recordsInPreparation).length === 0 ? (openBlock(), createElementBlock("div", _hoisted_14, [
                        createBaseVNode("p", _hoisted_15, toDisplayString(emptyText.value), 1)
              ...
              default: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_17, [
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("span", _hoisted_20, toDisplayString(unref(recordsDispatched).length), 1)
                    ]),
                    _hoisted_21
                  ]),
                  createBaseVNode("div", _hoisted_22, [
                    createBaseVNode("div", _hoisted_23, [
                      ...
                      createBaseVNode("h3", null, [
                        _hoisted_25,
                        createBaseVNode("span", _hoisted_26, toDisplayString(unref(recordsDispatched).length), 1)
                      ]),
                      createVNode(_component_KanbanDropdown, {
                    ...
                    createBaseVNode("div", {
                      ...
                      unref(recordsDispatched).length === 0 ? (openBlock(), createElementBlock("div", _hoisted_27, [
                        createBaseVNode("p", _hoisted_28, toDisplayString(emptyText.value), 1)
                      ])) : createCommentVNode("", true),
              ...
              default: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_30, [
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("span", _hoisted_33, toDisplayString(unref(recordsDelivered).length), 1)
                    ]),
                    _hoisted_34
                  ]),
                  createBaseVNode("div", _hoisted_35, [
                    createBaseVNode("div", _hoisted_36, [
                      ...
                      createBaseVNode("h3", null, [
                        _hoisted_38,
                        createBaseVNode("span", _hoisted_39, toDisplayString(unref(recordsDelivered).length), 1)
                      ]),
                      createVNode(_component_KanbanDropdown, {
                    ...
                    createBaseVNode("div", {
                      ...
                      unref(recordsDelivered).length === 0 ? (openBlock(), createElementBlock("div", _hoisted_40, [
                        createBaseVNode("p", _hoisted_41, toDisplayString(emptyText.value), 1)
                      ])) : createCommentVNode("", true),
