import { _ as __unplugin_components_0 } from "./VDropdown.d0ee03b8.js";
import { _ as _sfc_main$4 } from "./KanbanDropdown.cc692e1f.js";
import { _ as _sfc_main$3 } from "./VLoader.0f2164f0.js";
import { d as defineStore, b as defineComponent, r as ref, a as computed, o as onMounted, P as onUnmounted, f as openBlock, g as createElementBlock, X as createBaseVNode, Y as normalizeClass, D as createTextVNode, z as toDisplayString, Z as unref, C as createCommentVNode, w as createVNode, B as withCtx, F as Fragment, A as renderList, _ as createStaticVNode, ap as storeToRefs, L as watch, a6 as withDirectives, aq as vModelCheckbox, e as useHead } from "./vendor.0611facb.js";
import { u as useMesaSession, C as COMMAND_BAR, c as COMMAND_KITCHEN, b as MesaService, M as MasterService } from "./masterService.c3eb1ff6.js";
import { C as CommandStatusService, u as useComandaSession, i as initRealtime } from "./realtime.f5941764.js";
import { p as provideApi, u as useUserSession, R as ROLES, a as useCompanySession } from "./index.4a46f1be.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    const getProductsApi = async (showLoader = false) => {
      ...
      try {
        const response = await provideApi().get(`restaurant/command-status/items/0`);
        const data = response.data;
        if (data.success) {
    ...
    const filterProducts = (items) => {
      ...
      if (selectedTableId.value !== 0) {
        filtered = filtered.filter((p) => p.mesa_id === selectedTableId.value);
      }
    ...
    watch(() => productsStatusReceived.value.length, (next, prev) => {
      if (isFirstProductsLoad) {
              ...
              default: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_90, [
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("span", _hoisted_93, toDisplayString(unref(productsReceivedFiltered).length), 1)
                    ]),
                    _hoisted_94
                  ]),
                  createBaseVNode("div", _hoisted_95, [
                    createBaseVNode("div", _hoisted_96, [
                      ...
                      createBaseVNode("h3", null, [
                        createBaseVNode("span", _hoisted_98, toDisplayString(unref(productsReceivedFiltered).length), 1),
                        _hoisted_99
                      ]),
              ...
              default: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_103, [
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("span", _hoisted_106, toDisplayString(unref(productsProcessingFiltered).length), 1)
                    ]),
                    _hoisted_107
                  ]),
                  createBaseVNode("div", _hoisted_108, [
                    createBaseVNode("div", _hoisted_109, [
                      _hoisted_110,
                      createBaseVNode("h3", null, [
                        createBaseVNode("span", _hoisted_111, toDisplayString(unref(productsProcessingFiltered).length), 1),
                        _hoisted_112
                      ]),
                      createVNode(_component_KanbanDropdown, {
              ...
              default: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_116, [
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("span", _hoisted_119, toDisplayString(unref(productsToDeliverFiltered).length), 1)
                    ]),
                    _hoisted_120
                  ]),
                  createBaseVNode("div", _hoisted_121, [
                    createBaseVNode("div", _hoisted_122, [
                      _hoisted_123,
                      createBaseVNode("h3", null, [
                        createBaseVNode("span", _hoisted_124, toDisplayString(unref(productsToDeliverFiltered).length), 1),
                        _hoisted_125
                      ]),
                      createVNode(_component_KanbanDropdown, {
              ...
              default: withCtx(() => [
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_129, [
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("span", _hoisted_132, toDisplayString(unref(productsDeliveredFiltered).length), 1)
                    ]),
                    _hoisted_133
                  ]),
                  createBaseVNode("div", _hoisted_134, [
                    createBaseVNode("div", _hoisted_135, [
                      _hoisted_136,
                      createBaseVNode("h3", null, [
                        createBaseVNode("span", _hoisted_137, toDisplayString(unref(productsDeliveredFiltered).length), 1),
                        _hoisted_138
                      ]),
                      createVNode(_component_KanbanDropdown, {
