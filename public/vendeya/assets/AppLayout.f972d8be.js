import { _ as _sfc_main$b, C as CssUnitRe, a as __unplugin_components_0 } from "./VButton.fc4cbeca.js";
import { _ as _sfc_main$c, s as startConnection, q as qz, p as pageTitle, a as _sfc_main$g } from "./VIconButton.41406c32.js";
import { b as defineComponent, a as computed, f as openBlock, g as createElementBlock, y as renderSlot, Y as normalizeClass, Z as unref, r as ref, aj as useI18n, v as createBlock, B as withCtx, X as createBaseVNode, z as toDisplayString, w as createVNode, D as createTextVNode, C as createCommentVNode, T as Transition, N as Notyf, a6 as withDirectives, ak as vModelSelect, F as Fragment, A as renderList, x as resolveComponent, o as onMounted, al as resolveDirective, am as useWindowScroll, _ as createStaticVNode, u as useStorage, a5 as useRoute, t as reactive, an as watchPostEffect, L as watch } from "./vendor.b09305a7.js";
import { i as isDark, t as toggleDarkModeHandler, _ as __unplugin_components_1$1 } from "./IsotipoMozoOficial.6fcf915b.js";
import { _ as _sfc_main$e, a as _sfc_main$f } from "./VModal.ff5b02d6.js";
import { _ as __unplugin_components_1 } from "./VControl.bc7d1930.js";
import { _ as _sfc_main$d } from "./VField.6fe855fb.js";
import { u as useUserSession, p as provideApi, N as NAME_ROUTE_POS, R as ROLES, c as NAME_ROUTE_COMMANDS } from "./index.cecb72f7.js";
import { _ as __unplugin_components_4, u as useDropdown } from "./VDropdown.6720ff68.js";
import { u as useCompanySession, M as MasterService } from "./masterService.f4b2a4c8.js";
          ...
          unref(offlineReady) || unref(needRefresh) ? (openBlock(), createBlock(_component_VCard, {
            ...
            default: withCtx(() => [
              createBaseVNode("div", _hoisted_1$9, [
                unref(offlineReady) ? (openBlock(), createElementBlock("span", _hoisted_2$8, toDisplayString(unref(t2)("offline-ready", { appName: props.appName })), 1)) : (openBlock(), createElementBlock("span", _hoisted_3$8, toDisplayString(unref(t2)("need-refresh", { appName: props.appName })), 1))
              ]),
...
const _hoisted_1$8 = /* @__PURE__ */ createBaseVNode("div", { class: "icon" }, [
  /* @__PURE__ */ createBaseVNode("i", {
    class: "lnil lnil-printer",
    "aria-hidden": "true"
  })
], -1);
const _hoisted_2$7 = /* @__PURE__ */ createBaseVNode("div", { class: "meta" }, [
  /* @__PURE__ */ createBaseVNode("span", null, "Seleccionar impresora")
], -1);
const _hoisted_3$7 = [
  _hoisted_1$8,
  _hoisted_2$7
];
const _hoisted_4$7 = { class: "columns is-multiline is-mobile" };
...
const _hoisted_7$6 = /* @__PURE__ */ createBaseVNode("p", { class: "mb-0" }, "IMPRESORA DOCUMENTOS", -1);
...
const _hoisted_12$4 = /* @__PURE__ */ createTextVNode(" Guardar impresora documentos ");
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const printerNameDocument = userSession.printerNameDocument;
    const notyf = new Notyf();
    const dialogPrintAvailable = ref(false);
    const printers = ref([]);
    const isQZConnected = ref(false);
    const selectedPrinterDocument = ref(printerNameDocument);
    const openDialogPrintAvailable = () => {
      startConnection();
      isQZConnected.value = qz.websocket.isActive();
      getAllPrintersAvailable();
      dialogPrintAvailable.value = true;
    };
    const getAllPrintersAvailable = async () => {
      try {
    ...
    const selectPrintAvailableDocument = async () => {
      userSession.setPrinterNameDocument(selectedPrinterDocument.value);
      notyf.success("Impresora " + selectedPrinterDocument.value + " guardada correctamente.");
    };
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(_component_VModal, {
          ...
          actions: "right",
          "cancel-label": "Cerrar",
          onClose: _cache[1] || (_cache[1] = ($event) => dialogPrintAvailable.value = false)
        }, {
          content: withCtx(() => [
                      ...
                      default: withCtx(() => [
                        ...
                        createBaseVNode("div", _hoisted_8$6, [
                          withDirectives(createBaseVNode("select", {
                            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => selectedPrinterDocument.value = $event)
                          }, [
                            (openBlock(true), createElementBlock(Fragment, null, renderList(printers.value, (printer) => {
                              return openBlock(), createElementBlock("option", {
                                key: printer,
                                value: printer
                              }, toDisplayString(printer), 9, _hoisted_9$6);
                            }), 128))
                          ], 512), [
                ...
                createVNode(_component_VField, null, {
                  default: withCtx(() => [
                    createVNode(_component_VButton, {
                      ...
                      class: "",
                      size: "big",
                      onClick: selectPrintAvailableDocument
                    }, {
                      default: withCtx(() => [
                        _hoisted_12$4
                      ]),
