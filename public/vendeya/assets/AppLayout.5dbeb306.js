import { _ as _sfc_main$d, C as CssUnitRe, a as __unplugin_components_0 } from "./VButton.74b292a0.js";
import { _ as _sfc_main$e, f as findService, l as listPrinters, u as useCategoryViewSession, A as ALL_CATEGORY_ID, C as CATEGORY_TONES, a as CATEGORY_MODE_OPTIONS, b as CATEGORY_COLOR_STYLE_OPTIONS, c as CATEGORY_SIZE_OPTIONS, p as pageTitle, d as _sfc_main$i } from "./VIconButton.4c00b77a.js";
import { b as defineComponent, a as computed, f as openBlock, g as createElementBlock, y as renderSlot, Y as normalizeClass, Z as unref, r as ref, aj as useI18n, v as createBlock, B as withCtx, X as createBaseVNode, z as toDisplayString, w as createVNode, D as createTextVNode, C as createCommentVNode, T as Transition, I as withModifiers, a6 as withDirectives, ak as vModelSelect, F as Fragment, A as renderList, G as pushScopeId, H as popScopeId, _ as createStaticVNode, E as mergeProps, N as Notyf, x as resolveComponent, o as onMounted, al as resolveDirective, am as useWindowScroll, u as useStorage, a5 as useRoute, t as reactive, an as watchPostEffect, L as watch } from "./vendor.4fd38f72.js";
import { i as isDark, t as toggleDarkModeHandler, _ as __unplugin_components_1$2 } from "./IsotipoMozoOficial.a1a7fcdc.js";
import { _ as _sfc_main$g, a as _sfc_main$h } from "./VModal.794ccc5c.js";
import { _ as __unplugin_components_1$1 } from "./VControl.c5bb8a1f.js";
import { _ as _sfc_main$f } from "./VField.29c5f7a2.js";
import { u as useUserSession, a as useNotyf, p as provideApi, N as NAME_ROUTE_POS, R as ROLES, c as NAME_ROUTE_COMMANDS } from "./index.42a48c3f.js";
import { _ as _export_sfc } from "./plugin-vue_export-helper.5a098b48.js";
import { a as useProductSession, u as useCompanySession, M as MasterService } from "./masterService.9853fa55.js";
import { _ as __unplugin_components_5, u as useDropdown } from "./VDropdown.3ac27351.js";
...
if (typeof block0 === "function")
  block0(_sfc_main$b);
var AvailablePrinterDialog_vue_vue_type_style_index_0_scoped_true_lang = "";
const _withScopeId = (n2) => (pushScopeId("data-v-f8dfd582"), n2 = n2(), popScopeId(), n2);
const _hoisted_1$a = ["onClick"];
const _hoisted_2$8 = /* @__PURE__ */ createStaticVNode('<div class="icon" data-v-f8dfd582><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-printer" data-v-f8dfd582><path stroke="none" d="M0 0h24v24H0z" fill="none" data-v-f8dfd582></path><path d="M17 17h2a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2h-14a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2h2" data-v-f8dfd582></path><path d="M17 9v-4a2 2 0 0 0 -2 -2h-6a2 2 0 0 0 -2 2v4" data-v-f8dfd582></path><path d="M7 15a2 2 0 0 1 2 -2h6a2 2 0 0 1 2 2v4a2 2 0 0 1 -2 2h-6a2 2 0 0 1 -2 -2l0 -4" data-v-f8dfd582></path></svg></div><div class="meta" data-v-f8dfd582><span data-v-f8dfd582>Seleccionar impresora</span></div>', 2);
const _hoisted_4$9 = [
  _hoisted_2$8
];
const _hoisted_5$9 = { class: "printer-service-status" };
const _hoisted_6$8 = {
  key: 0,
  class: "mb-0"
};
...
const _hoisted_8$7 = /* @__PURE__ */ createTextVNode(" BuhoPrinter detectado en el puerto ");
const _hoisted_9$7 = /* @__PURE__ */ createTextVNode(" \u2014 los tickets salen directo desde este equipo, sin pasar por el servidor. ");
const _hoisted_10$7 = {
  key: 2,
  class: "mb-0"
};
const _hoisted_11$7 = /* @__PURE__ */ createTextVNode(" Buscar de nuevo ");
const _hoisted_12$5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("p", { class: "mb-1 has-text-weight-medium" }, "Impresora", -1));
const _hoisted_13$4 = {
  key: 0,
  class: "select is-fullwidth"
};
const _hoisted_14$4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("option", { value: "" }, "Sin asignar", -1));
...
const _hoisted_19$3 = /* @__PURE__ */ createTextVNode("Guardar");
const _hoisted_20$2 = {
  key: 2,
  class: "help mt-4"
};
const _hoisted_21$2 = /* @__PURE__ */ createTextVNode(" Sin el servicio local esta impresora se configura desde ");
const _hoisted_22$2 = ["href"];
const _hoisted_23$2 = /* @__PURE__ */ createTextVNode(". ");
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const selectedPrinter = ref((_a = userSession.printerNameDocument) != null ? _a : "");
    const serviceState = ref("checking");
    const servicePort = ref(null);
    const printers = ref([]);
    const url_base = userSession.ssl + userSession.url;
    const detectService = async (force = false) => {
      serviceState.value = "checking";
      printers.value = [];
      try {
        const port = await findService(force);
        servicePort.value = port;
        if (!port) {
          serviceState.value = "not-found";
          return;
        }
        printers.value = await listPrinters(port);
        serviceState.value = "found";
      } catch (err) {
        console.error("[buhoprinter] no se pudieron listar las impresoras:", err);
        serviceState.value = "not-found";
        servicePort.value = null;
      }
    };
    const options = computed(() => selectedPrinter.value && !printers.value.includes(selectedPrinter.value) ? [selectedPrinter.value, ...printers.value] : printers.value);
    const savePrinter = () => {
      userSession.setPrinterNameDocument(selectedPrinter.value);
      userSession.setPrinterNameDocumentPinned(true);
      notif.success(selectedPrinter.value ? `Los tickets se imprimir\xE1n en "${selectedPrinter.value}"` : "Impresora sin asignar");
      dialogPrintAvailable.value = false;
    };
    const openDialogPrintAvailable = () => {
      var _a2;
      dialogPrintAvailable.value = true;
      selectedPrinter.value = (_a2 = userSession.printerNameDocument) != null ? _a2 : "";
      detectService();
    };
    return (_ctx, _cache) => {
      const _component_VButton = _sfc_main$d;
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(_component_VModal, {
          ...
          title: "Impresora de este equipo",
          size: "medium",
          actions: "right",
          "cancel-label": "Cerrar",
          onClose: _cache[2] || (_cache[2] = ($event) => dialogPrintAvailable.value = false)
        }, {
          content: withCtx(() => [
            createBaseVNode("div", {
              class: normalizeClass(["notification is-light", serviceState.value === "found" ? "is-success" : "is-warning"])
            }, [
              createBaseVNode("div", _hoisted_5$9, [
                serviceState.value === "checking" ? (openBlock(), createElementBlock("p", _hoisted_6$8, " Buscando el servicio BuhoPrinter en este equipo... ")) : serviceState.value === "found" ? (openBlock(), createElementBlock("p", _hoisted_7$7, [
                  _hoisted_8$7,
                  createBaseVNode("strong", null, toDisplayString(servicePort.value), 1),
                  _hoisted_9$7
                ])) : (openBlock(), createElementBlock("p", _hoisted_10$7, " BuhoPrinter no responde en este equipo. Los tickets se env\xEDan a la cola de impresi\xF3n del servidor. ")),
                createVNode(_component_VButton, {
                  loading: serviceState.value === "checking",
                  onClick: _cache[0] || (_cache[0] = ($event) => detectService(true))
                }, {
                  default: withCtx(() => [
                    _hoisted_11$7
                  ]),
            ...
            createVNode(_component_VField, null, {
              default: withCtx(() => [
                createVNode(_component_VControl, null, {
                  default: withCtx(() => [
                    _hoisted_12$5,
                    serviceState.value === "found" ? (openBlock(), createElementBlock("div", _hoisted_13$4, [
                      withDirectives(createBaseVNode("select", {
                        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => selectedPrinter.value = $event)
                      }, [
                        _hoisted_14$4,
                        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(options), (printer) => {
                          return openBlock(), createElementBlock("option", {
                            key: printer,
                            value: printer
                          }, toDisplayString(printer), 9, _hoisted_15$4);
                        }), 128))
                      ], 512), [
                        [vModelSelect, selectedPrinter.value]
                      ])
            ...
            serviceState.value === "found" && printers.value.length === 0 ? (openBlock(), createElementBlock("p", _hoisted_17$3, " El servicio est\xE1 activo pero no reporta impresoras instaladas. ")) : createCommentVNode("", true),
            serviceState.value === "found" ? (openBlock(), createElementBlock("div", _hoisted_18$3, [
              createVNode(_component_VButton, {
                color: "primary",
                onClick: savePrinter
              }, {
            ...
            ])) : serviceState.value === "not-found" ? (openBlock(), createElementBlock("p", _hoisted_20$2, [
              _hoisted_21$2,
              createBaseVNode("a", {
                href: url_base + "/restaurant/configuration",
                target: "_blank",
                rel: "noopener noreferrer"
              }, "M\xF3dulo Restaurante \u2192 Configuraci\xF3n \u2192 Impresoras", 8, _hoisted_22$2),
              _hoisted_23$2
            ])) : createCommentVNode("", true)
          ]),
          _: 1
...
var __unplugin_components_1 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-f8dfd582"]]);
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_AvailablePrinterDialog = __unplugin_components_1;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_IsotipoMozoOficial = __unplugin_components_1$2;
      const _component_RouterLink = resolveComponent("RouterLink");
      const _component_UserProfileDropdown = _sfc_main$6;
