...
?>
    <div class="card welcome-component" style="display: <?php echo e($show_welcome_panel ? 'block' : 'none'); ?>;">
            ...
            <div class="row welcome-card-row">
                    ...
                    <div class="row justify-content-center align-items-center h-100">
                        <div class="p-0">
                            <div class="col-12 text-center mb-2 welcome-title">
                                <span class="h2 font-weight-bold">Hola <?php echo e(auth()->user()->name); ?>!</span>
                            </div>
                ...
                <div class="col-md-9 actions-cards-container">
                        ...
                        <div class="card shadow-sm border-top my-2 actions-card">
                            ...
                            <div class="card-body py-2">
                                <div class="row actions-cards-row">
                                    <?php if(auth()->user()->type != 'integrator' && $vc_company->soap_type_id != '03'): ?>
                                        <?php if(in_array('documents', $vc_modules)): ?>
                                            <?php if(in_array('new_document', $vc_module_levels)): ?>
                                                <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                                    <a href="<?php echo e(route('tenant.documents.create')); ?>" class="w-100 h-100 d-inline-block border bg-danger text-light rounded p-1">
                                    ...
                                    <?php if(in_array('sale_notes', $vc_module_levels)): ?>
                                        <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                            <a href="<?php echo e(route('tenant.sale_notes.create')); ?>" class="w-100 h-100 d-inline-block border bg-danger text-light rounded p-1">
                                                <div class="h-100 d-flex justify-content-center align-items-center">
                                                    <div class="contain-quick-actions">
                                                        <div class="svg-actions">
                                    ...
                                    <?php if(in_array('quotations', $vc_module_levels)): ?>
                                        <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                            <a href="<?php echo e(route('tenant.quotations.create')); ?>" class="w-100 h-100 d-inline-block border bg-danger text-light rounded p-1">
                                                <div class="h-100 d-flex justify-content-center align-items-center">
                                                    <div class="contain-quick-actions">
                                                        <div class="svg-actions">
                                    ...
                                    <?php if(in_array('documents', $vc_modules) && $vc_company->soap_type_id != '03'): ?>
                                        <?php if(in_array('list_document', $vc_module_levels)): ?>
                                            <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                                <a href="<?php echo e(route('tenant.documents.index')); ?>" class="w-100 h-100 d-inline-block border bg-danger text-light rounded p-1">
                                                    <div class="h-100 d-flex justify-content-center align-items-center">
                                                        <div class="contain-quick-actions">
                                                            <div class="svg-actions">
                            ...
                            <div class="card-body py-2">
                                <div class="row actions-cards-row">
                                    <?php if(in_array('items', $vc_module_levels)): ?>
                                        <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                            <a href="<?php echo e(route('tenant.items.index')); ?>" class="w-100 h-100 d-inline-block border bg-warning text-light rounded p-1">
                                                <div class="h-100 d-flex justify-content-center align-items-center">
                                                    <div class="contain-quick-actions">
                                                        <div class="svg-actions">
                                    ...
                                    <?php if(in_array('items_services', $vc_module_levels)): ?>
                                        <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                            <a href="<?php echo e(route('tenant.services')); ?>" class="w-100 h-100 d-inline-block border bg-warning text-light rounded p-1">
                                                <div class="h-100 d-flex justify-content-center align-items-center">
                                                    <div class="contain-quick-actions">
                                                        <div class="svg-actions">
                                    ...
                                    <?php if(in_array('inventory', $vc_modules)): ?>
                                        <?php if(in_array('inventory', $vc_module_levels)): ?>
                                            <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                                <a href="<?php echo e(route('inventory.index')); ?>" class="w-100 h-100 d-inline-block border bg-warning text-light rounded p-1">
                                                    <div class="h-100 d-flex justify-content-center align-items-center">
                                                        <div class="contain-quick-actions">
                                                            <div class="svg-actions">
                    ...
                    <?php if(auth()->user()->type != 'integrator'): ?>
                        <?php if(in_array('pos', $vc_modules_levels)): ?>
                            <div class="card shadow-sm border-top my-2 actions-card">
                                <div class="card-header py-1 font-weight-bold">
                                    Punto de venta
                                </div>
                                <div class="card-body py-2">
                                    <div class="row actions-cards-row">
                                        <?php if(in_array('pos', $vc_module_levels)): ?>
                                            <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                                <a href="<?php echo e(route('tenant.pos.index')); ?>" class="w-100 h-100 d-inline-block border bg-primary text-light rounded p-1">
                                                    <div class="h-100 d-flex justify-content-center align-items-center">
                                                        <div class="contain-quick-actions">
                                                            <div class="svg-actions">
                                        ...
                                        <?php if(in_array('cash', $vc_module_levels)): ?>
                                            <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                                <a href="<?php echo e(route('tenant.cash.index')); ?>" class="w-100 h-100 d-inline-block border bg-primary text-light rounded p-1">
                                                    <div class="h-100 d-flex justify-content-center align-items-center">
                                                        <div class="contain-quick-actions">
                                                            <div class="svg-actions">
                    ...
                    <?php if(in_array('accounting', $vc_modules) || in_array('reports', $vc_modules)): ?>
                        ...
                        <div class="card-body py-2">
                            <div class="row actions-cards-row">
                                <?php if(in_array('account_report', $vc_module_levels)): ?>
                                    <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                        <a href="<?php echo e(route('tenant.account_format.index')); ?>" class="w-100 h-100 d-inline-block border bg-success text-light rounded p-1">
                                            <div class="h-100 d-flex justify-content-center align-items-center">
                                                <div class="contain-quick-actions">
                                                    <div class="svg-actions">
                                ...
                                <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                    <a href="<?php echo e(route('tenant.reports.sales.index')); ?>" class="w-100 h-100 d-inline-block border bg-success text-light rounded p-1">
                                        <div class="h-100 d-flex justify-content-center align-items-center">
                                            <div class="contain-quick-actions">
                                                <div class="svg-actions">
                                ...
                                <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                    <a href="<?php echo e(route('tenant.reports.purchases.index')); ?>" class="w-100 h-100 d-inline-block border bg-success text-light rounded p-1">
                                        <div class="h-100 d-flex justify-content-center align-items-center">
                                            <div class="contain-quick-actions">
                                                <div class="svg-actions">
                                ...
                                <div class="col px-1 text-center" style="height: 100px; max-width: 25%">
                                    <a href="<?php echo e(route('tenant.reports.general_items.index')); ?>" class="w-100 h-100 d-inline-block border bg-success text-light rounded p-1">
                                        <div class="h-100 d-flex justify-content-center align-items-center">
                                            <div class="contain-quick-actions">
                                                <div class="svg-actions">
    ...
    <tenant-dashboard-index
        ...
        :configuration="<?php echo e(json_encode($configuration)); ?>">
    </tenant-dashboard-index>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('tenant.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Aplicaciones\laragon\sites\buho\pro9dev001\modules\Dashboard\Providers/../Resources/views/index.blade.php ENDPATH**/ ?>