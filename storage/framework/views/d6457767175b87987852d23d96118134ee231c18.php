...
<style>
    :root {
        --primary-h: <?php echo e($primaryHsl[0]); ?>;
        --primary-s: <?php echo e($primaryHsl[1]); ?>%;
        --primary-l: <?php echo e($primaryHsl[2]); ?>%;
    }
</style>
<?php endif; ?>

<?php if($headerTheme === 'dark'): ?>
<style>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Pro9\modules\Ecommerce\Providers/../Resources/views/layouts/partials_ecommerce/primary_color_style.blade.php ENDPATH**/ ?>