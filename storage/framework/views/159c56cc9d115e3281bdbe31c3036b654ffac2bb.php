...
<div class="dropdown cart-dropdown" style="margin-left: 16px;">
    ...
    <?php if(auth()->guard('ecommerce')->guest()): ?>
    ...
    <?php elseif(auth()->guard('ecommerce')->check()): ?>
        <a href="#" class="dropdown-toggle dropdown-toggle-ecommerce" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
            ...
            <div class="user-name-ecommerce d-flex align-items-center">
                ...
                <span class="text-name ml-2 mr-1"><?php echo e(Auth::guard('ecommerce')->user()->name); ?></span>
        ...
        <div class="dropdown-menu dropdown-menu-right user-menu">
            <div class="dropdownmenu-wrapper dropdown-ecommerce">
                <div class="user-menu-head">
                    <span class="user-menu-name"><?php echo e(Auth::guard('ecommerce')->user()->name); ?></span>
                    <span class="user-menu-email text-muted"><?php echo e(Auth::guard('ecommerce')->user()->email); ?></span>
                </div>

                <?php if(!$isRestaurant): ?>
                    <a href="<?php echo e(route('tenant_ecommerce_account')); ?>" class="dropdown-options user-menu-item">
                    ...
                    <a href="<?php echo e(route('tenant_document_list')); ?>" class="dropdown-options user-menu-item">
                        <span class="user-menu-ic">
                    ...
                    <a href="<?php echo e(route('tenant_order_list')); ?>" class="dropdown-options user-menu-item">
                        <span class="user-menu-ic">
                    ...
                    ?>
                    <?php if($quotationEnabledMenu): ?>
                    <a href="<?php echo e(route('tenant_ecommerce_quotation_list')); ?>" class="dropdown-options user-menu-item">
                        <span class="user-menu-ic">
        ...
        <form id="logout-form-header" action="<?php echo e(route('tenant_ecommerce_logout')); ?>" method="POST" style="display: none;">
            <?php echo csrf_field(); ?>
        </form>
    <?php endif; ?>

</div>
<?php /**PATH C:\laragon\www\Pro9\modules\Ecommerce\Providers/../Resources/views/partials/headers/session.blade.php ENDPATH**/ ?>