<script>
    window.__storefront_show_prices = <?php echo json_encode($storefront_show_prices ?? true); ?>;
</script>
<style>
...
<div class="header-search-wrapper" id="search-wrapper">
    <div class="header-dropdown header-dropdown-inside">
        <img src="<?php echo e(asset('images/search.svg')); ?>" alt="search" class="search-icon">
        <input
            placeholder="Buscar..."
            type="text"
    ...
    <div class="header-middle">
        <div class="container">
            <div class="header-left">
                <a href="<?php echo e(route("tenant.ecommerce.index")); ?>" class="logo" style="max-width: 180px">
                    <?php
                    ...
                    ?>
                    <?php if($headerLogo): ?>
                        <img src="<?php echo e(asset('storage/uploads/logos/'.$headerLogo)); ?>" alt="Logo" />
                    <?php else: ?>
            ...
            <div class="category-dropdown" id="category-dropdown">
                <button type="button" class="category-dropdown-toggle" id="category-toggle" <?php if(count($categories) == 0): ?> style="cursor: default; pointer-events: none;" <?php endif; ?>>
                ...
                <div class="category-menu" id="category-menu">
                    <div class="category-menu-grid">
                        ...
                        <a href="<?php echo e(route('tenant.ecommerce.category', \Illuminate\Support\Str::slug($category->name, '-'))); ?>" class="category-item">
                            <div class="category-item-icon">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(asset('logo/Image_not_available.png')); ?>"
                                         alt="<?php echo e($category->name); ?>"
                                         style="width:40px; height:40px; object-fit:cover; border-radius:8px;">
                                <?php endif; ?>
                            </div>
                            <div class="category-item-content">
                                <span class="category-item-title"><?php echo e($category->name); ?></span>
                            </div>
                        </a>
            ...
            <div class="customlinks" style="display: flex !important; align-items: center; flex-shrink: 0; white-space: nowrap; margin-right: 15px !important;">
                <?php if(!empty($customLinks['title_one']) && !empty($customLinks['link_one'])): ?>
                    <a href="<?php echo e($customLinks['link_one']); ?>" style="display: inline-block !important; font-weight: 500; font-size: 14px; color: var(--title-color); text-decoration: none; margin-left: 12px; white-space: nowrap;" target="_blank"><?php echo e($customLinks['title_one']); ?></a>
                <?php endif; ?>
                <?php if(!empty($customLinks['title_two']) && !empty($customLinks['link_two'])): ?>
                    <a href="<?php echo e($customLinks['link_two']); ?>" style="display: inline-block !important; font-weight: 500; font-size: 14px; color: var(--title-color); text-decoration: none; margin-left: 12px; white-space: nowrap;" target="_blank"><?php echo e($customLinks['title_two']); ?></a>
                <?php endif; ?>
                <?php if(!empty($customLinks['title_three']) && !empty($customLinks['link_three'])): ?>
                    <a href="<?php echo e($customLinks['link_three']); ?>" style="display: inline-block !important; font-weight: 500; font-size: 14px; color: var(--title-color); text-decoration: none; margin-left: 12px; white-space: nowrap;" target="_blank"><?php echo e($customLinks['title_three']); ?></a>
                <?php endif; ?>
            </div>
            ...
            <div class="header-right">
                ...
                <?php echo $__env->make('ecommerce::layouts.partials_ecommerce.cart_dropdown', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('ecommerce::partials.headers.session', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\Pro9\modules\Ecommerce\Providers/../Resources/views/layouts/partials_ecommerce/header.blade.php ENDPATH**/ ?>