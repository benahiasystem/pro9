...
?>
<?php if($ecommerceConfig && $ecommerceConfig->publicidad_activa): ?>
    <style>
        .announcement-bar {
            position: fixed;
            top: 0;
            ...
            display: none;
            width: 100%;
            background-color: <?php echo e($ecommerceConfig->publicidad_color_fondo); ?>;
        }
        .announcement-link {
    ...
    <div id="announcement-bar" class="announcement-bar">
        <div class="container text-center position-relative">
            <a href="<?php echo e($ecommerceConfig->publicidad_link ?? '#'); ?>" target="_blank" class="announcement-link">
                <?php echo e($ecommerceConfig->publicidad_texto); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Pro9\modules\Ecommerce\Providers/../Resources/views/layouts/partials_ecommerce/announcement_bar.blade.php ENDPATH**/ ?>