<header class="header" style="left:0;">
    <div class="logo-container m-2">
        ...
        ?>
        <?php if($logo): ?>
            <a href="<?php echo e(route('system.dashboard')); ?>" class="logo pt-2 pt-md-0">
        ...
        <?php else: ?>
            <a href="<?php echo e(route('system.dashboard')); ?>" class="text-logo pt-md-0">
                PANEL RESELLER
            </a>
        <?php endif; ?>
    ...
    <div class="header-right d-flex">
        ...
        <div id="userbox" class="userbox dropdown">
            <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="profile-info" data-lock-name="<?php echo e(\Auth::getUser()->email); ?>"
                    data-lock-email="<?php echo e(\Auth::getUser()->email); ?>">
                    <span class="name"><?php echo e(\Auth::getUser()->name); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-admin">
                <ul class="list-unstyled mb-0">
                    <li>
                        <a class="dropdown-item" role="menuitem" href="<?php echo e(route('system.users.create')); ?>">
                        ...
                        <a class="dropdown-item" role="menuitem" href="#" onclick="toggleThemeSidebar()">
                            ...
                            Estilos y Temas</a>
                        <a class="dropdown-item" role="menuitem" href="<?php echo e(route('logout')); ?>"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="18"  height="18"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-logout"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 8v-2a2 2 0 0 0 -2 -2h-7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h7a2 2 0 0 0 2 -2v-2" /><path d="M9 12h12l-3 -3" /><path d="M18 15l3 -3" /></svg>
                            <?php echo app('translator')->get('app.buttons.logout'); ?>
                        </a>
...
</header><?php /**PATH C:\Aplicaciones\laragon\sites\buho\pro9dev001\resources\views/system/layouts/partials/header.blade.php ENDPATH**/ ?>