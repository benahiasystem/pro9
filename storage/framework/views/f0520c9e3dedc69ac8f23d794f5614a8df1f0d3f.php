<?php $__currentLoopData = $dataPaginate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php
        ...
        $imagePath = $item->image !== 'imagen-no-disponible.jpg'
            ...
            : $defaultImagePath;
    ?>
    <div class="col-6 mb-2 <?php echo e(\Route::currentRouteName() == 'tenant.ecommerce.index' ? 'col-md-3' : 'col-md-4'); ?>">
        <div class="product product-style h-100 m-0 d-flex flex-column <?php echo e(stock($item, $configuration) ? 'productdisabled' : ''); ?>">
            <figure class="product-image-container product-image-container-ecommerce h-auto">

                <a href="/ecommerce/item/<?php echo e($item->id); ?>/<?php echo e(\Illuminate\Support\Str::slug($item->description)); ?>" class="product-image product-image-list">
                    <img src="<?php echo e($imagePath); ?>" class="image" alt="<?php echo e($item->description); ?>">
                </a>
                <a href="<?php echo e(route('item_partial', ['id' => $item->id])); ?>" class="btn-quickview"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-zoom-scan"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M4 8v-2a2 2 0 0 1 2 -2h2" /><path d="M4 16v2a2 2 0 0 0 2 2h2" /><path d="M16 4h2a2 2 0 0 1 2 2v2" /><path d="M16 20h2a2 2 0 0 0 2 -2v-2" /><path d="M8 11a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" /><path d="M16 16l-2.5 -2.5" /></svg> Vista Rápida</a>
                
                <?php if(json_encode($item->is_new) == 1): ?>
            ...
            <div class="product-details-ecommerce d-flex flex-column" style="flex: 1 1 auto">
                <div class="product-information">
                    <h2 class="product-title-ecommerce">
                        <a href="/ecommerce/item/<?php echo e($item->id); ?>/<?php echo e(\Illuminate\Support\Str::slug($item->description)); ?>"><?php echo e($item->description); ?></a>
                    </h2>

                    <?php if(isset($preferences['show_description']) && $preferences['show_description'] == 1): ?>
                        <?php if($item->name): ?>
                            <p class="text-muted product-description">
                                <?php echo e(strip_tags($item->name)); ?>
                    ...
                    <?php if(isset($preferences['show_stock']) && $preferences['show_stock'] == 1): ?>
                        <?php if($item->stock > 0): ?>
                        <h3 class="product-stock">Disponible:
                            <span><?php echo e(number_format($item->getStockByWarehouseMain(), 0)); ?></span>
                        </h3>
                        <?php else: ?>
                ...
                <div class="product-price-ecommerce mt-auto">
                    <?php if($storefront_show_prices ?? true): ?>
                    <div class="price-box-ecommerce">
                        <span class="old-price">S/ <?php echo e(number_format(round($item->sale_unit_price * 1.25), 2)); ?></span>


                        <span class="product-price-ecommerce"><?php echo e($item->currency_type['symbol']); ?> <?php echo e(number_format($item->sale_unit_price, 2)); ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="product-action">
                        <?php if(stock($item, $configuration)): ?>
               ...
               <?php else: ?>
                        <a href="#" class="paction add-cart" data-product="<?php echo e(json_encode( $item )); ?>" title="Add to Cart">
...
<?php /**PATH C:\laragon\www\Pro9\modules\Ecommerce\Providers/../Resources/views/layouts/partials_ecommerce/list_products.blade.php ENDPATH**/ ?>