...
<div class="row mt-5 mb-5 pt-4">
    ...
    <div class="col-lg-3 col-md-4 mb-4">
        <div class="account-sidebar">
            ...
            ?>
            <div class="user-mini">
              <div class="avatar"><?php echo e($account_initials); ?></div>
              <div>
                <div class="user-name text-dark"><?php echo e($account_full_name); ?></div>
                <div class="user-mail text-muted"><?php echo e($account_user->email); ?></div>
              </div>
            </div>
            <ul class="account-sidebar-menu">
                <li>
                    <a href="<?php echo e(route('tenant_ecommerce_account')); ?>" class="<?php echo e(request()->routeIs('tenant_ecommerce_account') ? 'active' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('tenant_order_list')); ?>" class="<?php echo e(request()->routeIs('tenant_order_list') ? 'active' : ''); ?>">
                ...
                ?>
                <?php if($quotationEnabledAccount): ?>
                <li>
                    <a href="<?php echo e(route('tenant_ecommerce_quotation_list')); ?>" class="<?php echo e(request()->routeIs('tenant_ecommerce_quotation_list') ? 'active' : ''); ?>">
                ...
                <?php endif; ?>
                <li>
                    <a href="<?php echo e(route('tenant_document_list')); ?>" class="<?php echo e(request()->routeIs('tenant_document_list') ? 'active' : ''); ?>">
                ...
                <?php endif; ?>
                <?php if(auth('ecommerce')->user()->addresses->count() > 0): ?>
                <li>
                    <a href="#" class="">
                ...
                <li style="margin-top: 10px; border-top: 1px solid #f0f0f0; padding-top: 15px;">
                    ...
                    <form id="logout-form-sidebar" action="<?php echo e(route('tenant_ecommerce_logout')); ?>" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
                    </form>
                </li>
            </ul>
...
<?php echo $__env->make('ecommerce::layouts.layout_ecommerce_cart.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Pro9\modules\Ecommerce\Providers/../Resources/views/layouts/layout_account.blade.php ENDPATH**/ ?>