...
<aside id="sidebar-left" class="sidebar-left mt-0" style="z-index: 900">
        <div class="header-mobile d-flex flex-column d-md-none">
            ...
            ?>
            <?php if($logo): ?>
                <a href="<?php echo e(route('system.dashboard')); ?>" class="logo pt-2 pt-md-0 position-relative">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('system.dashboard')); ?>" class="text-logo pt-md-0 position-relative">
                    PANEL RESELLER
                </a>
            <?php endif; ?>
        ...
        <div class="d-flex alig-items-center justify-content-start user-mobile d-md-none">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center" data-lock-name="<?php echo e(\Auth::getUser()->email); ?>"
                data-lock-email="<?php echo e(\Auth::getUser()->email); ?>">
                <span class="name fw-semibold text-primary-new"><?php echo e(\Auth::getUser()->name); ?></span>
                <span class="role"><?php echo e(\Auth::getUser()->email); ?></span>
            </div>
        </div>
    </div>
    <div class="nano px-2">
        <div class="nano-content">
            <nav id="menu" class="nav-main pt-1" role="navigation">
                <ul class="nav nav-main">
                    <li class="<?php echo e((in_array($path[0], ['clients', 'dashboard']))?'nav-active':''); ?>">
                        <?php if($sysAdmin && ($sysAdmin->reseller_id === null || $sysAdmin->canAccessSystemModule('clients'))): ?>
                        <a class="nav-link" href="<?php echo e(route('system.dashboard')); ?>">
            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <?php if($sysAdmin && $sysAdmin->canAccessSystemModule('admin-reseller')): ?>
                    <li class="<?php echo e(($path[0] === 'admin-reseller')?'nav-active':''); ?>">
                        <a class="nav-link" href="<?php echo e(route('system.admin_reseller.administrators.index')); ?>">
            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <?php if($sysAdmin && $sysAdmin->canAccessSystemModule('payment-orders')): ?>
                    <li class="<?php echo e(($path[0] === 'payment-orders')?'nav-active':''); ?>">
                        <a class="nav-link" href="<?php echo e(route('system.payments.index')); ?>">
            ...
            <?php if(config('configuration.multi_user_enabled') && $sysAdmin && $sysAdmin->canAccessSystemModule('multi-users')): ?>
                <nav id="menu" class="nav-main" role="navigation">
                    <ul class="nav nav-main">
                        <li class="<?php echo e(($path[0] === 'multi-users')?'nav-active':''); ?>">
                            <a class="nav-link" href="<?php echo e(route('system.multi-users.index')); ?>">
            ...
            <?php if($sysAdmin && $sysAdmin->canAccessSystemModule('plans')): ?>
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="<?php echo e(($path[0] === 'plans')?'nav-active':''); ?>">
                        <a class="nav-link" href="<?php echo e(route('system.plans.index')); ?>">
            ...
            <?php if($sysAdmin && $sysAdmin->canAccessSystemModule('massive-invoice')): ?>
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="<?php echo e(($path[0] === 'massive-invoice')?'nav-active':''); ?>">
                        <a class="nav-link" href="<?php echo e(route('system.massive-invoice.index')); ?>">
            ...
            <?php if($sysAdmin && $sysAdmin->canAccessSystemModule('auto-update')): ?>
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="<?php echo e(($path[0] === 'auto-update')?'nav-active':''); ?>">
                        <a class="nav-link" href="<?php echo e(route('system.update')); ?>">
            ...
            <?php endif; ?>
            <?php if($sysAdmin && $sysAdmin->canAccessSystemModule('backup')): ?>
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="<?php echo e(($path[0] === 'backup')?'nav-active':''); ?>">
                        <a class="nav-link" href="<?php echo e(route('system.backup')); ?>">
            ...
            <?php endif; ?>
            <?php if($sysAdmin && $sysAdmin->canAccessSystemModule('information')): ?>
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="<?php echo e(($path[0] === 'information')?'nav-active':''); ?>">
                        <a class="nav-link" href="<?php echo e(route('system.information')); ?>">
            ...
            <nav id="menu" class="nav-main pb-2" role="navigation">
                <ul class="nav nav-main">
                    <li class="<?php echo e(($path[0] === 'services')?'nav-active':''); ?>">
                        <a class="nav-link" href="<?php echo e(route('system.services')); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-apps"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 3h-4a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2h4a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2z" /><path d="M9 13h-4a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2h4a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2z" /><path d="M19 13h-4a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2h4a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2z" /><path d="M17 3a1 1 0 0 1 .993 .883l.007 .117v2h2a1 1 0 0 1 .117 1.993l-.117 .007h-2v2a1 1 0 0 1 -1.993 .117l-.007 -.117v-2h-2a1 1 0 0 1 -.117 -1.993l.117 -.007h2v-2a1 1 0 0 1 1 -1z" /></svg>
            ...
            <?php if($sysAdmin && $sysAdmin->canAccessSystemModule('logs')): ?>
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="">
                        <a class="nav-link" href="<?php echo e(url('logs')); ?>" target="_BLANK">
            ...
            <?php if($sysAdmin && $sysAdmin->canAccessSystemModule('reports')): ?>
            <nav id="menu" class="nav-main pb-2" role="navigation">
                <ul class="nav nav-main">
                    <li class="<?php echo e(($path[0] === 'reports')?'nav-active':''); ?>">
                        <a class="nav-link" href="<?php echo e(route('system.list-reports')); ?>">
    ...
    <?php if($sysAdmin && ($sysAdmin->reseller_id === null || $sysAdmin->canAccessSystemModule('configurations'))): ?>
    <nav id="menu" class="nav-main configuration-nav pt-0 px-2" role="navigation">
        <ul class="nav nav-main">
            <li class="<?php echo e(($path[0] === 'configurations')?'nav-active':''); ?>">
                <a class="nav-link" href="<?php echo e(route('system.configuration.index')); ?>">
        ...
        <ul class="nav nav-main d-md-none">
            <li class="<?php echo e(($path[0] === 'users')?'nav-active':''); ?>">
                <a class="nav-link" href="<?php echo e(route('system.users.create')); ?>">
        ...
        <ul class="nav nav-main d-md-none">
            <li class="<?php echo e(($path[0] === 'themes')?'nav-active':''); ?>">
        ...
        <ul class="nav nav-main d-md-none">
            <li class="<?php echo e(($path[0] === 'logout')?'nav-active':''); ?>">
                <a class="nav-link text-danger" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    ...
                    <span><?php echo app('translator')->get('app.buttons.logout'); ?></span>
                </a>
            </li>
        </ul>
    </nav>
...
<?php /**PATH C:\Aplicaciones\laragon\sites\buho\pro9dev001\resources\views/system/layouts/partials/sidebar.blade.php ENDPATH**/ ?>