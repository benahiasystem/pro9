            ...
            <div class="card card-dashboard card-reports">
                <div class="card-body">
                    ...
                    <ul class="card-report-links">
                        <li>
                            <a href="<?php echo e(route('system.report_login_lockout.index')); ?>">
                                Cuentas bloquedas
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('system.user_not_change_password.index')); ?>">
...
<?php echo $__env->make('system.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Aplicaciones\laragon\sites\buho\pro9dev001\modules\Report\Providers/../Resources/views/system/list_reports.blade.php ENDPATH**/ ?>