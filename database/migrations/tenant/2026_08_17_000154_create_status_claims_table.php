 ...
 * - `description`: varchar(60); NOT NULL; COLLATE utf8mb4_unicode_ci — Sin comentario definido en el esquema fuente.
 * - `color`: varchar(7); NOT NULL; DEFAULT #909399; COLLATE utf8mb4_unicode_ci — Sin comentario definido en el esquema fuente.
 * - `sort_order`: smallint(5) unsigned; NOT NULL; DEFAULT 0 — Sin comentario definido en el esquema fuente.
