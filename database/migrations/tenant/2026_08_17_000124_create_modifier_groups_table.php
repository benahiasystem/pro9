 ...
 * - `selection_type`: varchar(255); NOT NULL; DEFAULT single; COLLATE utf8mb4_unicode_ci — Sin comentario definido en el esquema fuente.
 * - `items`: json; NULL — Sin comentario definido en el esquema fuente.
...
SQL);
    ...
    {
        DB::unprepared('DROP TABLE IF EXISTS `modifier_groups`');
    }
};
