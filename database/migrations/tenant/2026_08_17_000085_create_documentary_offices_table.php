 ...
 * - `days`: mediumint(8) unsigned; NOT NULL; DEFAULT 0 — Sin comentario definido en el esquema fuente.
 * - `default`: tinyint(3) unsigned; NOT NULL; DEFAULT 0 — Sin comentario definido en el esquema fuente.
 * - `color`: varchar(255); NULL; COLLATE utf8mb4_unicode_ci — Sin comentario definido en el esquema fuente.
 */
...
SQL);
    ...
    {
        DB::unprepared('DROP TABLE IF EXISTS `documentary_offices`');
    }
};
