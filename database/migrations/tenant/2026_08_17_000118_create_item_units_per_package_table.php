 ...
 * Tabla: `item_units_per_package`.
 *
 * Inventario de columnas:
 * - `id`: int(10) unsigned; NOT NULL; auto_increment — Sin comentario definido en el esquema fuente.
 * - `item_id`: int(10) unsigned; NOT NULL — Sin comentario definido en el esquema fuente.
 * - `cat_item_units_per_package_id`: int(10) unsigned; NOT NULL — Sin comentario definido en el esquema fuente.
...
SQL);
    ...
    {
        DB::unprepared('DROP TABLE IF EXISTS `item_units_per_package`');
    }
};
