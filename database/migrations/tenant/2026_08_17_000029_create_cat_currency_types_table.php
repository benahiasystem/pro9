 ...
 * - `symbol`: varchar(255); NULL; COLLATE utf8mb4_unicode_ci — Sin comentario definido en el esquema fuente.
...
SQL);
    ...
    {
        DB::unprepared('DROP TABLE IF EXISTS `cat_currency_types`');
    }
};
// ######### FIN CAMBIO NELSON #########
