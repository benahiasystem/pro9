 ...
 * Tabla: `fixed_asset_purchase_items`.
 *
 * Inventario de columnas:
 * - `id`: int(10) unsigned; NOT NULL; auto_increment — Sin comentario definido en el esquema fuente.
 * - `fixed_asset_purchase_id`: int(10) unsigned; NOT NULL — Sin comentario definido en el esquema fuente.
 * - `fixed_asset_item_id`: int(10) unsigned; NOT NULL — Sin comentario definido en el esquema fuente.
