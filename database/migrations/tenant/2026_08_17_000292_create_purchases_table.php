 ...
 * - `purchase_order_id`: int(10) unsigned; NULL — Sin comentario definido en el esquema fuente.
 ...
 * - `period`: varchar(255); NULL; COLLATE utf8mb4_unicode_ci — Sin comentario definido en el esquema fuente.
 * - `date_registration`: datetime; NULL — Sin comentario definido en el esquema fuente.
 * - `related_invoice_number`: varchar(255); NULL; COLLATE utf8mb4_unicode_ci — Sin comentario definido en el esquema fuente.
 * - `related_invoice_serie`: varchar(255); NULL; COLLATE utf8mb4_unicode_ci — Sin comentario definido en el esquema fuente.
 * - `affectation`: varchar(255); NULL; COLLATE utf8mb4_unicode_ci — Sin comentario definido en el esquema fuente.
 */
