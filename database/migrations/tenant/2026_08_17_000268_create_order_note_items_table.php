 ...
 * Tabla: `order_note_items`.
 *
 * Inventario de columnas:
 * - `id`: int(10) unsigned; NOT NULL; auto_increment — Sin comentario definido en el esquema fuente.
 * - `order_note_id`: int(10) unsigned; NOT NULL — Sin comentario definido en el esquema fuente.
 ...
 * - `total_plastic_bag_taxes`: decimal(6,2); NULL; DEFAULT 0.00 — Impuesto bolsa plastica
 ...
 * - `additional_information`: longtext; NULL; COLLATE utf8mb4_unicode_ci — Informacion adcional
 * - `warehouse_id`: int(10) unsigned; NULL — Sin comentario definido en el esquema fuente.
 * - `name_product_pdf`: longtext; NULL; COLLATE utf8mb4_unicode_ci — Nombre del producto para el pdf
...
SQL);
    ...
    {
        DB::unprepared('DROP TABLE IF EXISTS `order_note_items`');
    }
};
