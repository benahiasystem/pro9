 ...
 * Tabla: `item_package_measurements`.
 *
 * Inventario de columnas:
 * - `id`: int(10) unsigned; NOT NULL; auto_increment — Sin comentario definido en el esquema fuente.
 * - `item_id`: int(10) unsigned; NOT NULL — Sin comentario definido en el esquema fuente.
 * - `cat_item_package_measurements_id`: int(10) unsigned; NOT NULL — Sin comentario definido en el esquema fuente.
...
SQL);
    ...
    {
        DB::unprepared('DROP TABLE IF EXISTS `item_package_measurements`');
    }
};
