 ...
 * - `delivery_date`: date; NULL — Sin comentario definido en el esquema fuente.
 ...
 * - `quotation_id`: int(10) unsigned; NULL; DEFAULT 0 — Relacion con cotizaciones
 ...
 * - `order_zone_id`: int(11); NULL — Sin comentario definido en el esquema fuente.
 * - `order_person_id`: int(11); NULL — Sin comentario definido en el esquema fuente.
 */
