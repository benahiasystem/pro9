 ...
 * - `percentage`: decimal(10,2); NOT NULL — Sin comentario definido en el esquema fuente.
...
SQL);
    ...
    {
        DB::unprepared('DROP TABLE IF EXISTS `cat_perception_types`');
    }
};
// ######### FIN CAMBIO NELSON #########
